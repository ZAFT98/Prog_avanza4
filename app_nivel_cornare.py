...
st.set_page_config(page_title="ESTACIÓN MARINILLA, DATOS PRECIPITACIONES", page_icon="🌊", layout="wide")
...
fecha_desde = st.sidebar.date_input("Desde", pd.to_datetime("2026-07-01")).strftime("%Y-%m-%d")
